    ...
    <div className="min-h-[70vh] flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md bg-white dark:bg-darkCard border border-gray-100 dark:border-darkBorder rounded-3xl p-6 md:p-8 shadow-xl space-y-6 text-left relative overflow-hidden">
        ...
        <div className="text-center relative z-10">
          <h2 className="text-2xl font-black text-gray-800 dark:text-white m-0">Create Account</h2>
          <p className="text-xs text-gray-400 mt-1.5">Sign up to get started on MERNShop</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4 relative z-10">
          <div className="flex flex-col gap-1.5">
            <label className="text-xs text-gray-450 dark:text-gray-400 font-semibold">Full Name</label>
